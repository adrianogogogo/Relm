      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-3xl shadow-2xl p-8 dark:border dark:border-slate-800">
          <div className="text-center mb-8">
            ...
            <h1 className="font-title text-3xl font-bold text-gray-800 mb-1">Área do Cliente</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit" disabled={isLoading} className="w-full btn btn-primary py-3 text-base font-bold disabled:opacity-50 disabled:cursor-not-allowed">
