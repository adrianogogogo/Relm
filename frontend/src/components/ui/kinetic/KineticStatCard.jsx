...
export default function KineticStatCard({
  ...
  return (
    ...
    >
        ...
        <span
          className={`w-2.5 h-2.5 rounded-full animate-pulse ${
            ledColor === 'green'
              ...
              : 'bg-[#ff4757] shadow-[0_0_10px_2px_rgba(255,71,87,0.8)]'
          }`}
        />
      </div>
      ...
      <span
        className="absolute -right-4 -bottom-4 font-mono text-[6rem] md:text-[7rem] font-bold leading-none select-none text-[#d1d9e6]/50 group-hover:text-[#ff4757]/10 transition-colors duration-300 pointer-events-none"
        aria-hidden="true"
      >
        {decorNumber}
      </span>
      ...
      <div className="relative z-10">
        {Icon && (
          <div className="mb-3 text-[#ff4757] p-2.5 w-11 h-11 rounded-xl bg-[#e0e5ec] shadow-[inset_2px_2px_5px_#babecc,inset_-2px_-2px_5px_#ffffff] flex items-center justify-center">
            <Icon size={22} />
          </div>
        )}
