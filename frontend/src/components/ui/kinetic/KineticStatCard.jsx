  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        {Icon && (
          <div className="mb-3 text-[#0A1929] dark:text-[#2196F3] p-2.5 w-11 h-11 rounded-xl bg-[#ccd3dd] dark:bg-[#171b21] shadow-[inset_7px_7px_12px_#8a92a0,inset_-6px_-6px_12px_#ffffff] dark:shadow-[inset_7px_7px_12px_#0a0d11,inset_-6px_-6px_12px_#2e353f] flex items-center justify-center">
            <Icon size={22} />
          </div>
        )}
