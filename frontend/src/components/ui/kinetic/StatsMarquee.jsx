...
export default function StatsMarquee({ items = [], speed = 60, className = '' }) {
  ...
  return (
    <div
      className={`w-full py-3.5 bg-[#e0e5ec] dark:bg-[#1c2128] text-[#2d3436] dark:text-[#f0f2f5] font-mono shadow-[inset_3px_3px_6px_#babecc,inset_-3px_-3px_6px_#ffffff] dark:shadow-[inset_3px_3px_6px_#12161b,inset_-3px_-3px_6px_#262c35] rounded-xl border border-white/40 dark:border-white/10 overflow-hidden ${className}`}
    >
