 ...
 * Sombra interna afundada (inset), fonte monospaçada JetBrains Mono e brilho de foco Safety Orange (#ff4757).
 *
 * Props:
    ...
    <div className={className}>
      ...
      <input
        className={`w-full h-12 px-4 bg-[#e0e5ec] text-[#2d3436] font-mono text-sm font-medium rounded-xl border-none
                   ...
                   focus:outline-none focus:shadow-[inset_4px_4px_8px_#babecc,inset_-4px_-4px_8px_#ffffff,0_0_0_2px_#ff4757]
